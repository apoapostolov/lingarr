...
| [ai-providers-model-fallback-chain.md](./ai-providers-model-fallback-chain.md) | Bedroom AI providers + fallback chain product design |
| [bedroom-reliability-development-plan.md](./bedroom-reliability-development-plan.md) | Production reliability audit → fixes |
