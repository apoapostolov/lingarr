...
public static class ApplicationBuilderExtensions
{
    ...
    private static async Task MigrateApiKeyEncryption(this WebApplication app)
    {
        ...
        [
            ...
            SettingKeys.Translation.OpenRouter.ApiKey,
            SettingKeys.Translation.Zai.ApiKey,
            SettingKeys.Translation.OpenCodeGo.ApiKey,
            SettingKeys.Translation.Qwen.ApiKey,
